...
import type { LiquidToken, LiquidTokenInterface } from '../LiquidToken';
...
export class LiquidToken__factory {
  static readonly abi = _abi;
  static createInterface(): LiquidTokenInterface {
    return new utils.Interface(_abi) as LiquidTokenInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider,
  ): LiquidToken {
    return new Contract(address, _abi, signerOrProvider) as LiquidToken;
  }
}
